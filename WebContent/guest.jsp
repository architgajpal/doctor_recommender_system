		...
		<main>
			...
			<section class="content flexy">
				<div class="box box--border box--small">
					...
					<form name="guestfields" style="color:#fff" method="post" action="guestfields" >
					<h3 >Fill this form to get recommendations</h3>
					...
					<div >
						...
						<input class="btn btn--default" type="submit" value="See Recommendations" />
