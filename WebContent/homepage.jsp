...
Class.forName("com.mysql.jdbc.Driver");
	...
	stmt = conn.createStatement();
       ...
       String sql;
       sql="select doc.doc_id,doc.work_experience,doc.no_of_cases,doc.doc_rating,doc.rating_count,doc.name,doc.mobile,doc.fee,doc.city,doc.speciality_code,t.result from doctor as doc,  trd as t,  user_disease as ud  where (ud.user_id="+session.getAttribute("user_id")+" and ud.speciality_code=doc.speciality_code and t.doc_id=doc.doc_id and t.result!='NR') order by t.result ASC";
...
Class.forName("com.mysql.jdbc.Driver");
	...
	stmt = conn.createStatement();
       ...
       String sql;
       sql="select doc.doc_id,doc.work_experience,doc.no_of_cases,doc.doc_rating,doc.rating_count,doc.name,doc.mobile,doc.fee,doc.city,doc.speciality_code,t.result from doctor as doc,  trd as t,  user_disease as ud  where (ud.user_id="+session.getAttribute("user_id")+" and doc.city='"+session.getAttribute("city")+"' and ud.speciality_code=doc.speciality_code and t.doc_id=doc.doc_id and t.result!='NR') order by t.result ASC";
...
Class.forName("com.mysql.jdbc.Driver");
	...
	stmt = conn.createStatement();
       ...
       String sql;
       sql="select doc.doc_id,doc.work_experience,doc.no_of_cases,doc.doc_rating,doc.rating_count,doc.name,doc.mobile,doc.fee,doc.city,doc.speciality_code,t.result from doctor as doc,  trd as t  where ( doc.city='"+session.getAttribute("city")+"' and t.doc_id=doc.doc_id and t.result!='NR') order by t.result ASC";
